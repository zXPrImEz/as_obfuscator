...
return {
	...
	Revision = REVISION;
	-- Config Starts Here
	IdentPrefix = "__aspect_"; -- The Prefix used for Identifiers generated by ASPECT. NOTE: There should be no identifiers in the script to be obfuscated starting with that prefix, because that can lead to weird bugs
