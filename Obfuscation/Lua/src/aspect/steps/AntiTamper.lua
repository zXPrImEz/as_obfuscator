...
local RandomStrings = require("aspect.randomStrings")
local Parser = require("aspect.parser");
local Enums = require("aspect.enums");
...
function AntiTamper:apply(ast, pipeline)
    ...
    code = code .. [[
    print("Obfuscated by aspect.wtf - discord.gg/aspectscripts")
    local tamperdetectedwhat = false
    local tamperdetected = "\n\n          .---.\n        ,'     `.\n      ;;'-------':.\n     ,;:  -o` o` :::     SKID DETECTED! FUCK YOU!\n   ,::'; .--(_)-.:::.\n   :::::(  __   )::::.\n   `:'`' \_____/ ;'`';_\n-       \   V   /      \| \n Vamos you shit skid, fuck you bitch\n\nuhm still join discord.gg/aspectscripts, thank you\n"
    local gmatch = string.gmatch;
    local err = function() error(tamperdetected) end;
